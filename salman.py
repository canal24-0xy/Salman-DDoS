...
time_loader = time.time() + int(input(f"{Fore.LIGHTBLUE_EX}::TIME ==⟩" ))
spam_loader = int(input(f"{Fore.LIGHTBLUE_EX}::SPAM ==⟩ {Fore.LIGHTYELLOW_EX}"))
create_thread = int(input(F"{Fore.LIGHTBLUE_EX}::CREATE TIME ==⟩ {Fore.LIGHTYELLOW_EX}"))
booter_sent = int(input(F"{Fore.LIGHTBLUE_EX}::REQUEST SENT ==⟩ {Fore.LIGHTYELLOW_EX}"))
